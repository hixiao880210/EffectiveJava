...
/**
 * Created by geekgao on 15-12-16.
 * 纯粹的学习一下java反射
 * 反射就是有了代表一个类的Class对象之后,利用这个Class对象可以访问类的所有信息,甚至生成一个新的对象,访问私有域
 */
...
public class ReflectionTest {
    ...
    public static void Demo2() throws ClassNotFoundException
    {
        ...
        class1 = Class.forName("com.effective.reflection.Person");
    ...
    {
        Class<?> class1 = null;
        class1 = Class.forName("com.effective.reflection.SuperMan");
